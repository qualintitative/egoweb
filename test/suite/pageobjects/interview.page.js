...
var IwPage = Object.create(Page, {
     ...
     * define elements
     */
    form: { get: function () { return browser.element('#answerForm'); }},
    startInterviewLink: { get: function () { return browser.element('=Start new interview'); }},
    nextButton: { get: function () { return browser.element('button.orangebutton=Next'); }},
    backButton: { get: function () { return browser.element('button.graybutton=Back'); }},
    dkLabel: { get: function() { return browser.element('label=Don\'t Know')}},
    rfLabel: { get: function() { return browser.element('label=Refuse')}},
    questionTitle: { get: function() { return browser.element('span#questionTitle')}},
     ...
     */
    inputField: { value: function(id) {
        return browser.element('input#Answer_'+id+'_VALUE');
    }},

    specificQuestionTitle: { value: function(question) {
        return browser.element('span#questionTitle='+question);
    }},

    goBackToQuestion: { value: function(question) {
    ...
    goForwardToQuestion: { value: function(question) {
    ...
    openInterview: { value: function(interview) {
        this.open('interview');
