...
class Question extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, active, title, subjectType, answerType, askingStyleList, ordering, otherSpecify, noneButton, allButton, pageLevelDontKnowButton, pageLevelRefuseButton, dontKnowButton, refuseButton, allOptionString, uselfExpression, minLimitType, minLiteral, minPrevQues, maxLimitType, maxLiteral, maxPrevQues, minCheckableBoxes, maxCheckableBoxes, withListRange, listRangeString, minListRange, maxListRange, timeUnits, symmetric, keepOnSamePage, studyId, answerReasonExpressionId, networkRelationshipExprId, networkParams, networkNColorQId, networkNSizeQId, networkEColorQId, networkESizeQId, useAlterListField, restrictList, autocompleteList, prefillList', 'length', 'max'=>4096),
	...
	public function attributeLabels()
	{
		return array(
			...
			'noneButton' => 'Allow alters already listed in other name generators',
			'allButton' => 'All Button',
			'prefillList' => 'Pre-fill Alters from List',
			...
			'symmetric' => 'symmetric',
			'keepOnSamePage' => 'Show Previous Session Alters',
			'studyId' => 'Study',
