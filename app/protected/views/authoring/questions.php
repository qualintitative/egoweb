        ...
        <form :id="'form-' + question.id" method="post">
            ...
            <div class="row card-body">
                <div class="col-md-6">
                    ...
                    <div class="offset-md-4 col-md-8 form-group row">
                        <b-form-checkbox v-if="question.subjectType == 'EGO'" class="col-5 mb-1" :id="question.id + '_askingStyleList'" v-model="question.askingStyleList" name="Question[askingStyleList]" value="1" unchecked-value="0">
                            Stem and Leaf
                        </b-form-checkbox>
                        <b-form-checkbox v-if="question.subjectType != 'NAME_GENERATOR' && question.subjectType != 'EGO_ID' && question.subjectType != 'EGO'" class="col-5 mb-1" :id="question.id + '_askingStyleList'" v-model="question.askingStyleList" name="Question[askingStyleList]" value="1" unchecked-value="0">
                            List Style
                        </b-form-checkbox>
