...
<?php
    ...
    foreach ($interviews as $interview) {
        ...
        echo "<div class='multiRow' style='width:200px;text-align:left'>".Html::checkbox('export[]', false, array('class'=>"export",'value'=>$interview->id, "id"=>"export-$interview->id,")). " " .  $egoIds[$interview->id] . "</div>";
