...
<?php
    ...
    foreach($interviews as $interview){
        ...
        echo "<div class='multiRow'>".Html::button('Review',array('onclick'=>"document.location='".Url::to('/interview/'.$study->id.'/'.$interview->id . "#/page/0'")))."</div>";
        echo "<div class='multiRow'>".Html::button('Visualize',array('submit'=>Url::to("rootUrl + '/data/visualize?expressionId=&interviewId=$interview->id'")))."</div>";
