                            ...
                            <?php if (isset($interviews[$study->id]) && count($interviews[$study->id]) > 0): ?>
                                <div class="col-sm-9">
                                    <table id="study-<?php echo $study->id; ?>" class="table table-bordered table-list study-table">
                                        <thead>
                                            <tr>
                                                <th class="bg-dark text-white">Continue incomplete interview</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($interviews[$study->id] as $interview): ?>
                                                <tr>
                                                    <td><?php echo Html::a($egoIds[$interview->id], ["/interview/" . $study->id . "/" . $interview->id . "#page/" . $interview->completed], ["class" => "list-group-item list-group-item-action"]); ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
