...
class Study extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('introduction, egoIdPrompt, alterPrompt, conclusion', 'length', 'max'=>4294967295),
