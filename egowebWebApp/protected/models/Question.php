...
class Question extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, active, title, prompt, preface, citation, subjectType, answerType, askingStyleList, ordering, otherSpecify, noneButton, allButton, pageLevelDontKnowButton, pageLevelRefuseButton, dontKnowButton, refuseButton, allOptionString, uselfExpression, minLimitType, minLiteral, minPrevQues, maxLimitType, maxLiteral, maxPrevQues, minCheckableBoxes, maxCheckableBoxes, withListRange, listRangeString, minListRange, maxListRange, timeUnits, symmetric, keepOnSamePage, studyId, answerReasonExpressionId, networkRelationshipExprId, networkNShapeQId, networkNColorQId, networkNSizeQId, networkEColorQId, networkESizeQId, useAlterListField', 'length', 'max'=>4096),
			array('id, active, title, prompt, preface, citation, subjectType, answerType, askingStyleList, ordering, otherSpecify, noneButton, allButton, pageLevelDontKnowButton, pageLevelRefuseButton, dontKnowButton, refuseButton, allOptionString, uselfExpression, minLimitType, minLiteral, minPrevQues, maxLimitType, maxLiteral, maxPrevQues, minCheckableBoxes, maxCheckableBoxes, withListRange, listRangeString, minListRange, maxListRange, timeUnits, symmetric, keepOnSamePage, studyId, answerReasonExpressionId, networkRelationshipExprId, networkNShapeQId, networkNColorQId, networkNSizeQId, networkEColorQId, networkESizeQId', 'safe', 'on'=>'search'),
		);
	}
