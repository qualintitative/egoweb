...
class ImportExportController extends Controller
{
	public function actionImportstudy()
	{
		...
		foreach($newQuestions as $newQuestion){
			if($newQuestion->networkNShapeQId != 0)
